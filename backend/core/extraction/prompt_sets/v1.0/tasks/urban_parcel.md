...
- Take each field from the sentence that states it for that parcel; raw_text is that phrase.
...
- Conditions that are none of the fields go into other_conditions, one per condition, as printed.
- Leave columns empty.
